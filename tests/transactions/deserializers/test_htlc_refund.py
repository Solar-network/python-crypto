...
def test_htlc_refund_deserializer():
    ...
    assert (
        actual.signature
        == "16d9ef1dceb0cbb105a45af6bdde9439055f07197643f9e2837312463330fd02ec7b13d1242becfe333c1b8ab2ea91c0c8240390d86f0fb0f6cdc22ec6ac64f1"
    )
    assert actual.amount == 0
    assert (
        actual.asset["refund"]["lockTransactionId"]
