...
def test_vote_deserializer(transaction_type_burn):
    ...
    assert (
        ...
        == "03fe61f79ee50c5f45acfc37b33c3a5c10e2afe0204e3c8fa2a2d3d73a2b412360"
    )  # noqa
    assert (
        actual.signature
        == "ef071aa1c7631a6ace4227f583c78d922e938a1c3a8997a959e834e6b43ece34313a68dcf56ac606fb387006d9cbc962249376326c9dd84b81979eed5d1163d8"
    )
