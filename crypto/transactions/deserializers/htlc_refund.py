...
class HtlcRefundDeserializer(BaseDeserializer):
    def deserialize(self):
        ...
        self.transaction.asset["refund"] = {"lockTransactionId": lock_transaction_id.decode()}

        self.transaction.parse_signatures(hexlify(self.serialized).decode(), self.asset_offset + 64)
